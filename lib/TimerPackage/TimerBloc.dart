...
import 'package:flutterbloc/TimerPackage/Ticker.dart';
...
class TimerBloc extends Bloc<TimerEvent, TimerState> {
  ...
  Stream<TimerState> _mapTimerStartedToState(TimerStarted start) async* {
    ...
    _tickerSubscription?.cancel();
    _tickerSubscription =
        _ticker.tick(ticks: start.duration).listen((duration) => add(TimerTicked(duration: duration)));
  }
